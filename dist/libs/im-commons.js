...
var _bowerSockjsClient = require('./bower-sockjs-client');

var _bowerSockjsClient2 = _interopRequireDefault(_bowerSockjsClient);
...
var WebMessageBridge = function () {
  ...
  _createClass(WebMessageBridge, [{
    ...
    value: function connect(token, endpoint, connectedCallback) {
      ...
      // };
      _this.sockjs = new _bowerSockjsClient2.default(_this.endpoint, null, null);
